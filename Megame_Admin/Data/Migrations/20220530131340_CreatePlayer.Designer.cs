...
namespace Megame_Admin.Migrations
{
    ...
    [Migration("20220530131340_CreatePlayer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatUserIdentity", b =>
                {
            ...
            modelBuilder.Entity("Megame_Admin.Models.BaseUser", b =>
                {
                    ...
                    b.Property<DateTime>("Birthday")
                        ...
                        .HasDefaultValue(new DateTime(2022, 5, 30, 13, 13, 39, 976, DateTimeKind.Utc).AddTicks(3474));
            ...
            modelBuilder.Entity("Megame_Admin.Models.PlayerMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Megame_Admin.Models.UserIdentity", b =>
                {
                    ...
                    b.Property<DateTime>("RegistrationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 13, 13, 39, 962, DateTimeKind.Utc).AddTicks(569));
            ...
            modelBuilder.Entity("ChatUserIdentity", b =>
                {
                    b.HasOne("Megame_Admin.Models.Chat", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Megame_Admin.Models.PlayerMessage", b =>
                {
                    b.HasOne("Megame_Admin.Models.Player", "Player")
                        .WithMany("PlayerMessages")
